...
public class AddRecipeActivity extends AppCompatActivity {
    ...
    private EditText etTitle, etPrepTime, etCalories, etAllergens, etIngredients, etInstructions, etRecipeImageUrl;
    ...
    private void bindViews() {
        ...
        etRecipeImageUrl = findViewById(R.id.etRecipeImageUrl);
        ...
        dbService.getRecipe(recipeId, new DatabaseService.DatabaseCallback<>() {
            ...
            public void onCompleted(Recipe recipe) {
                if (recipe != null) {
                    ...
                    etRecipeImageUrl.setText(recipe.getImageUrl());
    ...
    private void saveRecipe() {
        ...
        String imageUrl = etRecipeImageUrl.getText().toString().trim();
        ...
        if (title.isEmpty() || imageUrl.isEmpty() || prepTimeStr.isEmpty() || caloriesStr.isEmpty() || ingredientsStr.isEmpty() || instructionsStr.isEmpty()) {
        ...
        try {
            ...
            Toast.makeText(this, "נא להזין מספרים תקינים בזמן הכנה וקלוריות.", Toast.LENGTH_SHORT).show();
            return;
        }
